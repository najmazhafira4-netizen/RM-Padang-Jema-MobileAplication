...
Future<void> _fetchRiwayat() async {
  ...
  // Di dalam ListView.builder HalamanRiwayat bagian itemBuilder:
itemBuilder: (context, index) {
  final dataPesanan = _riwayat[index]; 
  
  return Card(
    margin: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
    elevation: 2, // Tambah sedikit bayangan agar lebih bagus
    ...
    child: ListTile(
      ...
      // Menampilkan Nama (Mendukung huruf kapital atau kecil dari Apps Script)
      title: Text(
        dataPesanan['Nama'] ?? dataPesanan['nama'] ?? 'Tanpa Nama', 
        style: const TextStyle(fontWeight: FontWeight.bold)
      ),
      // Menampilkan Waktu dan Meja saja
      subtitle: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        // Mengambil data menu (Mendukung huruf besar atau kecil dari script)
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 20), // Memberi jarak agar teks tidak mepet
          Expanded(
            child: Text(
              value, 
